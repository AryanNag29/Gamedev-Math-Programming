...
public class ClockScript : MonoBehaviour
{
    ...
    [Range(0, 60)] public float angSecMinHand = 1;
    [Range(0, 24)] public float angHourHand = 1;

    [Range(0, 0.2f)] public float TickSizeSecMinHand = 0.05f;
    [Range(0, 0.2f)] public float TickSizeHourHand = 0.3f;
